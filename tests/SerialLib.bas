''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' SerialLib.bas (C) 2005 Sutron Corporation
'
' This is a library of functions that may be used to communicate with
' a serial port which is under the control of the Coms Manager and/or 'ote.
' For ports which are not inuse, the standard file I/O api built-in to Xpert Basic
' should be used.
'
' The library uses TCP/IP socket communications to take control of the port from
' Remote. Strings may be read or written, control lines can be toggled, and
' there is a command to issue Hayes commands and get back the result.
'
' This code may be freely modified or adapted as long as it is used on Sutron
' equipment and this notice is not removed.
' Constants that may be reused by other Basic Programs using this Library
'
...
Const LoggingIn=2
Const LoggedIn=4
' Subroutines and Function declarations that may be reused by other Basic
...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' Open's a COM port in the specified mode

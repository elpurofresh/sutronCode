...
Public Sub SCHED_MainThermo
	...
	For i = 0 to 4
		...
		'SData = AdDC(1, 3, 4, 1.8)
		'SData = Ad(1, 3, 4, 1.8)		
		'Temp = 1.01*SData - 1992.92
		StatusMsg "SData: " & SData
		'StatusMsg "Temp: " & Temp
		Log LogFile, Now, "Sensor" & i, Format("%f", SData), "G", "Ohms"
		'Log LogFile, Now, "Sensor" & i & " Tem: ", Format("%3.3f", Temp), "G", "Deg"

		Sleep 2.0 					'Sleep for 1 second
		Call SwitchTo(-1) 			'Reset the ADC Switch
		Sleep 0.50 					'Sleep for 0.5 second
